...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_geo_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f25b33aa#;
   pragma Export (C, u00001, "geo_testsB");
   ...
   u00132 : constant Version_32 := 16#d81a7889#;
   pragma Export (C, u00132, "geo_magB");
   u00133 : constant Version_32 := 16#46599621#;
   pragma Export (C, u00133, "geo_magS");
   u00134 : constant Version_32 := 16#03e83d1c#;
   pragma Export (C, u00134, "ada__numerics__elementary_functionsB");
   u00135 : constant Version_32 := 16#d250ebd1#;
   pragma Export (C, u00135, "ada__numerics__elementary_functionsS");
   u00136 : constant Version_32 := 16#3c1a89cd#;
   pragma Export (C, u00136, "ada__numerics__aux_floatS");
   u00137 : constant Version_32 := 16#effcb9fc#;
   pragma Export (C, u00137, "ada__numerics__aux_linker_optionsS");
   u00138 : constant Version_32 := 16#3935e87c#;
   pragma Export (C, u00138, "ada__numerics__aux_long_floatS");
   u00139 : constant Version_32 := 16#8333dc5f#;
   pragma Export (C, u00139, "ada__numerics__aux_long_long_floatS");
   u00140 : constant Version_32 := 16#e2164369#;
   pragma Export (C, u00140, "ada__numerics__aux_short_floatS");
   u00141 : constant Version_32 := 16#b13844f6#;
   pragma Export (C, u00141, "system__exn_fltS");
   u00142 : constant Version_32 := 16#d71ab463#;
   pragma Export (C, u00142, "system__fat_fltS");
   u00143 : constant Version_32 := 16#10f5aae8#;
   pragma Export (C, u00143, "geo_mag__commonB");
   u00144 : constant Version_32 := 16#f4ae30d2#;
   pragma Export (C, u00144, "geo_mag__commonS");
   u00145 : constant Version_32 := 16#7c0734fc#;
   pragma Export (C, u00145, "geo_mag__convertionsB");
   u00146 : constant Version_32 := 16#21bc7b76#;
   pragma Export (C, u00146, "geo_mag__convertionsS");
   u00147 : constant Version_32 := 16#66c5d290#;
   pragma Export (C, u00147, "geo_mag__dataS");
   u00148 : constant Version_32 := 16#797f65a6#;
   pragma Export (C, u00148, "geo_mag__data__egms9615S");
   u00149 : constant Version_32 := 16#c3f91483#;
   pragma Export (C, u00149, "geo_mag__data__initializationB");
   u00150 : constant Version_32 := 16#c5bbbb01#;
   pragma Export (C, u00150, "geo_mag__data__initializationS");
   u00151 : constant Version_32 := 16#b820b640#;
   pragma Export (C, u00151, "geo_mag__magnetic_modelB");
   u00152 : constant Version_32 := 16#044e3753#;
   pragma Export (C, u00152, "geo_mag__magnetic_modelS");
   u00153 : constant Version_32 := 16#f3766160#;
   pragma Export (C, u00153, "geo_mag__magnetic_model__readB");
   u00154 : constant Version_32 := 16#e18a47a0#;
   pragma Export (C, u00154, "ada__float_text_ioB");
   u00155 : constant Version_32 := 16#a31d9ddf#;
   pragma Export (C, u00155, "ada__float_text_ioS");
   u00156 : constant Version_32 := 16#5e511f79#;
   pragma Export (C, u00156, "ada__text_io__generic_auxB");
   u00157 : constant Version_32 := 16#d2ac8a2d#;
   pragma Export (C, u00157, "ada__text_io__generic_auxS");
   u00158 : constant Version_32 := 16#1b1598b6#;
   ...
   u00160 : constant Version_32 := 16#f4d42833#;
   pragma Export (C, u00160, "system__float_controlS");
   u00161 : constant Version_32 := 16#1efd3382#;
   pragma Export (C, u00161, "system__img_utilB");
   u00162 : constant Version_32 := 16#6331cfb6#;
   pragma Export (C, u00162, "system__img_utilS");
   u00163 : constant Version_32 := 16#b132d2b7#;
   pragma Export (C, u00163, "system__powten_fltS");
   u00164 : constant Version_32 := 16#c66ce239#;
   pragma Export (C, u00164, "system__img_lfltS");
   u00165 : constant Version_32 := 16#f128bd6e#;
   pragma Export (C, u00165, "system__fat_lfltS");
   u00166 : constant Version_32 := 16#8438771b#;
   pragma Export (C, u00166, "system__img_lluS");
   u00167 : constant Version_32 := 16#b82039c7#;
   pragma Export (C, u00167, "system__powten_lfltS");
   u00168 : constant Version_32 := 16#8dbcc555#;
   pragma Export (C, u00168, "system__img_llfS");
   u00169 : constant Version_32 := 16#8bf81384#;
   pragma Export (C, u00169, "system__fat_llfS");
   u00170 : constant Version_32 := 16#8fb1834c#;
   pragma Export (C, u00170, "system__powten_llfS");
   u00171 : constant Version_32 := 16#c3bdb2c8#;
   pragma Export (C, u00171, "system__val_fltS");
   u00172 : constant Version_32 := 16#2611fc39#;
   pragma Export (C, u00172, "system__val_lfltS");
   u00173 : constant Version_32 := 16#0f79a52f#;
   pragma Export (C, u00173, "system__exn_lfltS");
   u00174 : constant Version_32 := 16#86c64e74#;
   pragma Export (C, u00174, "system__val_llfS");
   u00175 : constant Version_32 := 16#22d7655f#;
   pragma Export (C, u00175, "system__exn_llfS");
   u00176 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00176, "ada__integer_text_ioB");
   u00177 : constant Version_32 := 16#b4dc53db#;
   pragma Export (C, u00177, "ada__integer_text_ioS");
   u00178 : constant Version_32 := 16#dddfe8f1#;
   pragma Export (C, u00178, "system__img_biuS");
   u00179 : constant Version_32 := 16#90812f2f#;
   pragma Export (C, u00179, "system__img_llbS");
   u00180 : constant Version_32 := 16#5eeebe35#;
   pragma Export (C, u00180, "system__img_lliS");
   u00181 : constant Version_32 := 16#e770da5d#;
   pragma Export (C, u00181, "system__img_lllbS");
   u00182 : constant Version_32 := 16#ad86ddd3#;
   pragma Export (C, u00182, "system__img_llliS");
   u00183 : constant Version_32 := 16#ed04c351#;
   pragma Export (C, u00183, "system__img_lllwS");
   u00184 : constant Version_32 := 16#ccb35a24#;
   pragma Export (C, u00184, "system__img_llwS");
   u00185 : constant Version_32 := 16#e20553c3#;
   pragma Export (C, u00185, "system__img_wiuS");
   u00186 : constant Version_32 := 16#aa0160a2#;
   pragma Export (C, u00186, "system__val_intS");
   u00187 : constant Version_32 := 16#5da6ebca#;
   pragma Export (C, u00187, "system__val_unsS");
   u00188 : constant Version_32 := 16#a5fee39b#;
   pragma Export (C, u00188, "system__val_llliS");
   u00189 : constant Version_32 := 16#1e4a2c79#;
   pragma Export (C, u00189, "system__val_llluS");
   u00190 : constant Version_32 := 16#603adc29#;
   pragma Export (C, u00190, "ada__strings__fixedB");
   u00191 : constant Version_32 := 16#b4492da2#;
   pragma Export (C, u00191, "ada__strings__fixedS");
   u00192 : constant Version_32 := 16#fb589256#;
   pragma Export (C, u00192, "ada__strings__searchB");
   u00193 : constant Version_32 := 16#a44727a7#;
   pragma Export (C, u00193, "ada__strings__searchS");
   u00194 : constant Version_32 := 16#6acb1d2b#;
   pragma Export (C, u00194, "geo_mag__mathB");
   u00195 : constant Version_32 := 16#54c33cc3#;
   pragma Export (C, u00195, "geo_mag__mathS");
   u00196 : constant Version_32 := 16#0b903427#;
   pragma Export (C, u00196, "geo_mag__math__compute_alfB");
   u00197 : constant Version_32 := 16#8f2423cb#;
   ...
   --  geo_mag.common%b
   --  geo_mag.data%s
   --  geo_mag.convertions%s
   --  geo_mag.data.egms9615%s
   --  geo_mag.convertions%b
   --  geo_mag.data.initialization%s
   --  geo_mag.data.initialization%b
   --  geo_mag.magnetic_model%s
   --  geo_mag.magnetic_model%b
   --  geo_mag.magnetic_model.read%b
   --  geo_mag.math%s
   --  geo_mag.math%b
   --  geo_mag.math.compute_alf%b
   --  geo_mag%b
   --  geo_tests%b
